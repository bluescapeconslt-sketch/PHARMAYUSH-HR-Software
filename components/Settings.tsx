...
import { CompanySettings, BuddySettings } from '../types.ts';
import { BUDDY_AVATAR as defaultBuddyAvatar } from '../constants.tsx';
    ...
    <Card title="Company Settings">
      <div className="max-w-2xl mx-auto">
        <form onSubmit={handleSubmit} className="space-y-6 divide-y divide-gray-200">
            ...
            {/* --- Pharmayush Buddy Section --- */}
            <div className="py-6">
                <h3 className="text-lg font-semibold text-gray-800 mb-4">Pharmayush Buddy Avatar</h3>
                <div className="space-y-6">
                    <div>
                     ...
                     {buddySettings.avatarImage && (
                        ...
                        <span className="block text-sm font-medium text-gray-500">Avatar Preview</span>
                            <div className="flex items-center gap-4 mt-2">
                                <img src={buddySettings.avatarImage} alt="Pharmayush Buddy Preview" className="h-20 w-20 object-contain bg-gray-100 p-2 rounded-md border" />
                                <button
                                    type="button"
                                    onClick={() => setBuddySettings({ avatarImage: defaultBuddyAvatar })}
                                    className="px-3 py-1 text-xs font-medium text-red-700 bg-red-100 rounded-full hover:bg-red-200"
                                >
                                    Reset to Default
                                </button>
