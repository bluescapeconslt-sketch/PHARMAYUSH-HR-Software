...
import { Employee, LeaveRequest, OnboardingTask, Policy, Role, Permission, Notice, Department, Meeting, Position } from './types.ts';
...
export const EMPLOYEES: Employee[] = [
  { id: 1, name: 'Alice Johnson', position: 'Dept. Head', jobTitle: 'Software Engineer', department: 'Technology', email: 'alice.j@example.com', password: 'password', roleId: 2, avatar: 'https://picsum.photos/id/1027/200/200', status: 'Active', birthday: '1990-05-15', leaveBalance: { vacation: 12, sick: 5, personal: 2 } },
  { id: 2, name: 'Bob Smith', position: 'Manager', jobTitle: 'Product Manager', department: 'Product', email: 'bob.s@example.com', password: 'password', roleId: 2, avatar: 'https://picsum.photos/id/1005/200/200', status: 'Active', birthday: '1988-08-22', leaveBalance: { vacation: 15, sick: 7, personal: 3 } },
  { id: 3, name: 'Charlie Brown', position: 'Employee', jobTitle: 'UX Designer', department: 'Design', email: 'charlie.b@example.com', password: 'password', roleId: 2, avatar: 'https://picsum.photos/id/1011/200/200', status: 'On Leave', birthday: '1992-11-30', leaveBalance: { vacation: 5, sick: 6, personal: 1 } },
  { id: 4, name: 'Diana Prince', position: 'CEO', jobTitle: 'System Administrator', department: 'Human Resources', email: 'admin@example.com', password: 'admin', roleId: 1, avatar: 'https://picsum.photos/id/1012/200/200', status: 'Active', birthday: '1985-03-10', leaveBalance: { vacation: 20, sick: 10, personal: 5 } },
  { id: 5, name: 'Ethan Hunt', position: 'Intern', jobTitle: 'QA Engineer', department: 'Technology', email: 'ethan.h@example.com', password: 'password', roleId: 2, avatar: 'https://picsum.photos/id/1013/200/200', status: 'Active', birthday: '1995-07-01', leaveBalance: { vacation: 8, sick: 4, personal: 0 } },
];
...
export const BUDDY_AVATAR = 'data:image/png;base64,- so on...';
...
export const ICONS = {
    ...
    meetings: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>,
};